...
map.getView().fit([108.062767, 4.505754, 135.396778, 20.584584], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Philippine Population Data Map in Year 2020</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (220 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This is a simple webmap showcasing the population on various provinces within the Philippines, categorized using colors from highly populated to least populated. Map was processed in QGIS, and made using qgis2web plugin.';
            }
